...
$sentencia= mysqli_query($conect,"INSERT INTO direccion(idUsuario,codigoPostalUsuario,estado,municipio,colonia,callePrincipal,numeroExterior,calle1,calle2,referencia,statusDireccion)
VALUES($Iden,'$codigoPostalUsuario','$estado','$municipio','$colonia','$callePrincipal','$numeroExterior','$calle1','$calle2','$referencia','1')");
