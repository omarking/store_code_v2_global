<?php
    ...
    include("../fedex/Autorizacion.php");

    $nombreComprador = $_POST["nombreComprador"];
    $numeroTelef     = $_POST["numeroTelefono"];
    $pais            = $_POST["pais"];
    $estado          = $_POST["estado"];
    $ciudad          = $_POST["ciudad"];
    ...
    echo($nombreComprador.$numeroTelef.$pais.$estado.$ciudad.$codigoPost.$colonia.$calle1.$calle2.$referencia);
