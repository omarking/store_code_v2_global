...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-8  col-sm-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title text-center" style="color: #0B3861;">Actualizar Marca</h5>    
                        <?php             
                        $idMosMarca =$_GET["actmarca"];                                              
                        include("../model/conexion.php");                                 
                        $sqlMoMarc="SELECT * FROM marca WHERE marca.idMarca = '$idMosMarca';";
                        $resMosMar=mysqli_query($conect,$sqlMoMarc);
                        mysqli_close($conect); 
                        while($rowMoMar=mysqli_fetch_row($resMosMar)){                        
                                ?>                        
                    <form action="controladoractualizamarca.php" method="post">
                            <input type="hidden" name="txtIdMarca" value="<?php echo $rowMoMar[0];?>">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Marca</label>
                            <input type="text" class="form-control" name="txtMarca" value="<?php echo $rowMoMar[1];?>">                
                        </div>
                        <div class="form-group">
                            <p>Estatus:</p>
                                <div>                                                                                                
